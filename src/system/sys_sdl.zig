  ...
  renderHeight:u16) !void 
{
    ...
    window = c.SDL_CreateWindow("zig-engine",
        SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
        @intCast(c_int, windowWidth), @intCast(c_int, windowHeight),
    ...
    renderTexture = c.SDL_CreateTexture(
        ...
        @intCast(c_int, renderWidth), @intCast(c_int, renderHeight));
}
